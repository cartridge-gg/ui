...
export function LayoutContent({ children, className, }) {
    ...
    return (_jsxs("div", { ref: containerRef, className: cn("w-full p-4 flex flex-col items-stretch gap-4 overflow-y-scroll", mbCompensation, isIframe() && "flex-1", className), style: {
            scrollbarWidth: "none",
