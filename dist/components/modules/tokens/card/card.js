...
export const TokenCard = ({ image, title, amount, increasing, decreasing, value, change, clickable = true, squaredImage = true, variant, className, ...props }) => {
    const [hover, setHover] = useState(false);
    const Logo = useMemo(() => (_jsx(Thumbnail, { icon: image, size: "lg", variant: hover ? "lighter" : "light", rounded: !squaredImage })), [image, hover]);
    const style = useMemo(() => {
