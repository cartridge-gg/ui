...
export declare const TokenCard: ({ image, title, amount, increasing, decreasing, value, change, clickable, squaredImage, variant, className, ...props }: TokenCardProps) => import("react/jsx-runtime").JSX.Element;
