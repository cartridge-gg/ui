...
export declare const TokenCard: ({ image, title, amount, increasing, decreasing, value, change, clickable, roundedImage, variant, className, ...props }: TokenCardProps) => import("react/jsx-runtime").JSX.Element;
