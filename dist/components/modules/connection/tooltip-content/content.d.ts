...
export declare const ConnectionTooltipContent: ({ username, address, chainId, followers, followings, hideNetwork, setOpen, onFollowersClick, onFollowingsClick, variant, className, }: ConnectionTooltipContentProps) => import("react/jsx-runtime").JSX.Element;
