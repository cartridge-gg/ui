...
export declare const ConnectionTooltip: ({ username, address, chainId, followers, followings, hideUsername, hideNetwork, onFollowersClick, onFollowingsClick, onLogout, variant, className, children, ...props }: ConnectionTooltipProps) => import("react/jsx-runtime").JSX.Element;
