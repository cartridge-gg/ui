...
export const ConnectionTooltip = ({ username, address, chainId, followers, followings, hideUsername, hideNetwork, onFollowersClick, onFollowingsClick, variant, className, children, ...props }) => {
