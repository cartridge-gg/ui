...
export const TraceabilityCollectibleCard = ({ username, timestamp, category, collectibleImage, collectibleName, currencyImage, amount, quantity, variant, className, ...props }) => {
    ...
    return (_jsx(TraceabilityCard, { username: username, timestamp: timestamp, Icon: _jsx(CategoryIcon, { category: category }), variant: variant, className: className, onMouseEnter: () => setHover(true), onMouseLeave: () => setHover(false), ...props, children: _jsxs(_Fragment, { children: [_jsxs("div", { className: "h-6 flex items-center gap-0.5 bg-translucent-dark-100 p-1 rounded", children: [CollectibleIcon, _jsx("p", { className: "text-xs text-foreground-100 px-0.5", children: quantity ? `${quantity} ${collectibleName}` : collectibleName })] }), amount !== undefined && (_jsxs("div", { className: "flex items-center gap-0.5 bg-translucent-dark-100 p-1 rounded", children: [CurrencyIcon, _jsx("p", { className: "text-xs text-foreground-100 px-0.5", children: amount.toLocaleString() })] }))] }) }));
};
