...
export declare const ActivityCard: ({ Logo, title, subTitle, topic, subTopic, badge, error, loading, variant, className, ...props }: ActivityCardProps) => import("react/jsx-runtime").JSX.Element;
