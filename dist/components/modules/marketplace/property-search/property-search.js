...
export const MarketplacePropertySearch = React.forwardRef(({ search, setSearch, className, variant, ...props }, ref) => {
    const [focus, setFocus] = useState(false);
    return (_jsxs("div", { ref: ref, className: "relative", ...props, children: [_jsx(Input, { className: cn(marketplacePropertySearchVariants({ variant }), className), type: "text", placeholder: "Search", value: search, onChange: (e) => setSearch(e.target.value), onFocus: () => setFocus(true), onBlur: () => setFocus(false) }), _jsx(SearchIcon, { "data-focused": focus, "data-content": search.length > 0 && !focus, className: cn("absolute right-2 top-1/2 -translate-y-1/2 transition-colors duration-100", "text-foreground-400 data-[content=true]:text-foreground-300 data-[focused=true]:text-foreground-100 ") })] }));
});
