...
export declare function CollectibleHeader({ title, icon, label, hover, selectable, selected, onSelect, variant, className, ...props }: CollectibleHeaderProps): import("react/jsx-runtime").JSX.Element;
