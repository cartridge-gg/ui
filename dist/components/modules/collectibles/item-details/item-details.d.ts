...
export declare function CollectibleItemDetails({ owner, quantity, price, expiration, variant, className, ...props }: CollectibleItemDetailsProps): import("react/jsx-runtime").JSX.Element;
