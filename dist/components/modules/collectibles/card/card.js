...
export function CollectibleCard({ title, images, icon, backgroundColor, totalCount, listingCount, price, lastSale, selectable = false, selected, onSelect, variant, className, onError, ...props }) {
    return (_jsxs("div", { "data-selected": selected, className: cn(collectibleCardVariants({ variant }), props.onClick !== undefined ? "cursor-pointer" : "cursor-default", className), ...props, children: [_jsx(CollectibleHeader, { selectable: selectable, selected: selected, onSelect: onSelect, variant: variant }), _jsx(CollectiblePreview, { title: title, icon: icon, images: images, size: "sm", totalCount: totalCount, listingCount: listingCount, onError: onError, backgroundColor: backgroundColor }), _jsx(CollectibleCardFooter, { price: price, lastSale: lastSale, variant: variant })] }));
}
