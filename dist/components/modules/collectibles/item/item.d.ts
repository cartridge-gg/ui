...
export declare function CollectibleItem({ owner, quantity, price, expiration, action, onActionClick, variant, className, ...props }: CollectibleItemProps): import("react/jsx-runtime").JSX.Element;
