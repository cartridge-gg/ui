...
export var CoinflowPaymentStatus;
(function (CoinflowPaymentStatus) {
    CoinflowPaymentStatus["Failed"] = "FAILED";
    CoinflowPaymentStatus["Pending"] = "PENDING";
    CoinflowPaymentStatus["Succeeded"] = "SUCCEEDED";
})(CoinflowPaymentStatus || (CoinflowPaymentStatus = {}));
...
export var PurchaseFulfillmentStatus;
(function (PurchaseFulfillmentStatus) {
    PurchaseFulfillmentStatus["AwaitingPayment"] = "AWAITING_PAYMENT";
    PurchaseFulfillmentStatus["Confirmed"] = "CONFIRMED";
    PurchaseFulfillmentStatus["Failed"] = "FAILED";
    PurchaseFulfillmentStatus["Processing"] = "PROCESSING";
    PurchaseFulfillmentStatus["Queued"] = "QUEUED";
    PurchaseFulfillmentStatus["Submitted"] = "SUBMITTED";
})(PurchaseFulfillmentStatus || (PurchaseFulfillmentStatus = {}));
/** RPCLogAuthDecision is enum for the field auth_decision */
export var RpcLogAuthDecision;
(function (RpcLogAuthDecision) {
    RpcLogAuthDecision["Allowed"] = "allowed";
    RpcLogAuthDecision["Blocked"] = "blocked";
    RpcLogAuthDecision["WouldBeBlocked"] = "would_be_blocked";
})(RpcLogAuthDecision || (RpcLogAuthDecision = {}));
