...
export var LayerswapNetwork;
(function (LayerswapNetwork) {
    LayerswapNetwork["Arbitrum"] = "ARBITRUM";
    LayerswapNetwork["Base"] = "BASE";
    LayerswapNetwork["Ethereum"] = "ETHEREUM";
    LayerswapNetwork["Optimism"] = "OPTIMISM";
    LayerswapNetwork["Solana"] = "SOLANA";
})(LayerswapNetwork || (LayerswapNetwork = {}));
export var LayerswapPaymentStatus;
(function (LayerswapPaymentStatus) {
    LayerswapPaymentStatus["Confirmed"] = "CONFIRMED";
    LayerswapPaymentStatus["Expired"] = "EXPIRED";
    LayerswapPaymentStatus["Failed"] = "FAILED";
    LayerswapPaymentStatus["Pending"] = "PENDING";
})(LayerswapPaymentStatus || (LayerswapPaymentStatus = {}));
