...
const propertySearchVariants = cva(
  "pr-9 caret-foreground-100",
  {
    variants: {
      variant: {
...
export interface PropertySearchProps extends HTMLAttributes<HTMLDivElement>, VariantProps<typeof propertySearchVariants> {
  search: string;
  setSearch: (search: string) => void;
}

export const PropertySearch = React.forwardRef<HTMLDivElement, PropertySearchProps>(
  (
    {search, setSearch, className, variant, ...props },
    ref,
  ) => {
