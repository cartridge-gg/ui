...
const marketplaceHeaderLabelVariants = cva(
  "flex px-2 py-3 select-none",
  {
    variants: {
      variant: {
...
export const MarketplaceHeaderLabel = React.forwardRef<HTMLDivElement, MarketplaceHeaderLabelProps>(
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(marketplaceHeaderLabelVariants({ variant }))}
        {...props}
      >
        <p>{label}</p>
        {children}
