  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        ...
        <Button onClick={showDestructiveToast} variant="destructive" className="w-full">
          Show Error Toast
        </Button>
        <Button onClick={showToastWithAction} variant="outline" className="w-full">
          Show Toast with Action
        </Button>
      </div>

      <div className="text-xs text-gray-400 mt-4">
        These are the existing toast notifications using the original Radix-based system
      </div>
...
{`toast({
  ...
  variant: "default"
        ...
        <div className="space-y-3">
          <h3 className="font-medium text-green-400">Specialized Toast Components</h3>
          <div className="text-sm space-y-2">
  ...
  progress: 100
      ...
      <div className="mt-6 p-4 bg-gray-800 rounded">
        ...
        <ul className="text-sm space-y-1">
          <li>• Use <strong>existing toasts</strong> for simple notifications and confirmations</li>
          <li>• Use <strong>specialized toasts</strong> for game events, achievements, and rich interactions</li>
          <li>• Both systems work together seamlessly through the same useToast hook</li>
          <li>• All toasts appear in the same viewport with consistent positioning</li>
        </ul>
      </div>
    </div>
  ),
